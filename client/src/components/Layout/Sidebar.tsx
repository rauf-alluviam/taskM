...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, collapsed, onCollapseToggle }) => {
  ...
  return (
    <>
      ...
      <div className={`
        flex flex-col bg-white dark:bg-slate-800 shadow-xl border-r border-gray-200 dark:border-slate-700 h-full w-full
      ...
      `}>
        <div className={`flex h-16 items-center border-b border-gray-200 dark:border-slate-700 flex-shrink-0 ${collapsed ? 'justify-center' : 'px-4 justify-between'}`}>
            ...
            <NavLink
              ...
              className={({ isActive }) => `
                ...
                ${isActive 
                  ...
                  : 'text-gray-700 dark:text-slate-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-700'
                }
              `}
